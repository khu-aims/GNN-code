...
if __name__ == '__main__':
    ...
    parameters = {'n_estimators': [100, 200, 300], 'max_depth':[6,8,10,12]}
    ...
    for fold in range(n_folds):
        ...
        print('    The best parameter: %.2e with BAC of %f' % (grid.best_params_['n_estimators'], grid.best_score_))
        start_time = time.time()

        clf = RandomForestClassifier(n_estimators=grid.best_params_['n_estimators'], max_depth = grid.best_params_['max_depth'], random_state=123)
